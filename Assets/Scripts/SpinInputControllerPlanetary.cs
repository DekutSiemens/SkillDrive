...
public class SpinInputControllerPlanetary : MonoBehaviour
{
    [Header("UI References")]
    public TMP_InputField[] spinSpeedInputFields = new TMP_InputField[6]; // Array for 6 input fields
    ...
    void Start()
    {
        ...
        if (spinSpeedInputFields.Length != 6)
        {
